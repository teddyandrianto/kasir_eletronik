          ...
          <div class="box-body">
            <div class="col-sm-6">
              ...
              <div class="col-sm-3">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control input-lg" id="text" value="<?php echo $trx->total ?>" name="text" readonly>
                </div>
            ...
            <div class="col-sm-6 form-horizontal">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">          
                  <input type="number" class="form-control" placeholder="bayar" name="bayar" value="<?php echo $trx->bayar ?>" readonly="">
                </div>
              </div>  
            </div> 
            <a href="<?php echo base_url('kasir/histori_transaksi') ?>"  class="btn btn-success pull-right">Kembali <span class="fa fa-level-down"></span></a>
            </form>
            ...
            <div class="box-body">
              <table id="myTable" class="table table-bordered table-hover" width="100%">
                ...
                <tr>
                  ...
                  <td><?php echo $dt->harga_jual*$dt->jumlah ?></td>
                </tr>
              <?php } ?>
            </tbody>
            </table>
